...
export type CodecKeyValueStoreCasDeps<T> = {
  codec: Codec<T>
  bytesStore: BytesKeyValueStoreCas
}

export class CodecKeyValueStoreCas<T> implements KeyValueStoreCas<T> {
  public constructor(private readonly deps: CodecKeyValueStoreCasDeps<T>) {}
