...
export declare class PinoLogger<TContext extends LogContext = LogContext> implements Logger<TContext> {
    ...
    constructor(deps?: PinoLoggerDeps, opts?: Partial<LoggerOptions>, context?: LogContextPatch);
    private init;
    private toPinoMeta;
...
export declare function createPinoLogger<TContext extends LogContext = LogContext>(deps?: PinoLoggerDeps, opts?: Partial<LoggerOptions>, context?: LogContextPatch): Logger<TContext>;
